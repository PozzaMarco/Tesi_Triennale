...
\begin{figure}[h]
	\centering
	\includegraphics[scale=0.25]{immagini/git}
	\caption{Logo Git}
\end{figure}
\\
...
\begin{figure}[h]
	\centering
	\includegraphics[scale=0.25]{immagini/gitCommands}
...
\begin{figure}[h]
	\centering
	\includegraphics[scale=0.25]{immagini/astah}
...
Astah Professional, disponibile in verione gratuita grazie alla licenza accademica.
\begin{figure}[h]
	\centering
...
\end{figure}
\\
Oltre a questo, \textit{Visual Studio Code}, ha un integrazione con diretta con\gls{git}. Questo fa sì che ci sia una finestra dedicata per il controllo delle differenze tra i file modificate che permette di fare il \textit{commit} delle modifiche online sia su server \gls{git} privati che su \gls{repository} presenti su GitHub \cite{gitGuida} \cite{gitSite}.
\subsection{Framework di sviluppo e testing}
\subsubsection{Truffle Suite}
\begin{figure}[h]
	\centering
	\includegraphics[scale=0.5]{immagini/truffle}
...
\begin{figure}[h]
	\centering
	\includegraphics[scale=0.5]{immagini/solidity}
