...
\begin{figure}[!h]
	\centering
	%\includegraphics[width=0.5\textwidth]{immagini/identity_wallet_handler}
...
\begin{figure}[!h]
	\centering
	%\includegraphics[width=0.5\textwidth]{immagini/ID_list}
...
\begin{figure}[!h]
	\centering
	%\includegraphics[width=0.5\textwidth]{immagini/Identity}
...
\begin{figure}[!h]
	\centering
	%\includegraphics[width=0.5\textwidth]{immagini/TTP_key_list}
...
\begin{figure}[!h]
	\centering
	%\includegraphics[width=0.5\textwidth]{immagini/trusted_third_party}
