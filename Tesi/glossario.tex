...
\newglossaryentry{dapp}{
	name= DApp,
	description={Abbreviazione per \textit{decentralized application}. Una Dapp è semplicemente del codice che gira su una rete decentralizzata peer-to-peer e si differenzia delle normali applicazioni inquanto girano su server centralizzati.\\
...
\newglossaryentry{contract\_oriented}{
